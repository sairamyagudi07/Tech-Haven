...
const AdminOrders = () => {
  ...
  return (
    <div className="w-full container mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        <table className="w-full table-fixed border border-gray-300 rounded-lg shadow-md">
          <thead>
            <tr className="bg-gray-100 text-gray-700 border-b border-gray-300">
              <th className="p-4 w-[150px] text-left">Order ID</th>
              <th className="p-4 w-[150px] text-left">Total</th>
              <th className="p-4 w-[300px] text-left">Address</th>
              <th className="p-4 w-[150px] text-left">Status</th>
            </tr>
          </thead>
          <tbody>
            {orders.map((order, index) => (
              <tr key={order.id} className="border-b border-gray-300">
                ...
                <td className="p-4 text-left text-gray-700 truncate">
                  {randomAddresses[index]}
                </td>
